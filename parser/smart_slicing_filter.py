...
def packet_parser(mini_window_duration=1, max_mws=2, mode=0, verbose=0, file_name="/mnt/notimer_mini-windows.csv"):
    """
    ...
    capture = pyshark.LiveCapture(interface='net3',only_summaries= True,bpf_filter = "(tcp or udp or sip or stun or dtls ) and ((ip.src==192.168.3.0/24 and ip.dst==192.168.20.0/24) or (ip.src==192.168.20.0/24 and ip.dst==192.168.3.0/24))")
